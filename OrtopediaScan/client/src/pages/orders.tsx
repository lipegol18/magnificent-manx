...
const orderStatus = {
  ...
  "aguardando_envio": { label: "Aguardando envio", color: "bg-orange-700/70 text-orange-200" },
...
export default function Orders() {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      setFilteredOrdersData(Array.isArray(data) ? data : []);
                      ...
                      <CardContent className="p-0">
                        ...
                        <div className="py-2 px-4 flex justify-between items-center">
                          ...
                          <div className="flex gap-2">
                            ...
                            {order.status === "aceito" && (
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setScheduleDate(order.procedureDate || "");
                                }}
                              >
                            ...
                            {/* Botão de recurso - só aparece se status for "recusado" */}
